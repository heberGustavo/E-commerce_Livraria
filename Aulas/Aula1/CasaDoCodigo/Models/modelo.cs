...
namespace CasaDoCodigo.Models
{
    ...
    //Todas classes que herdam essa, elas vão ter um id
    [DataContract] //Atributo que permite a Serialização, pode ser convertida em Objeto
    public class BaseModel
    {
        [DataMember] //Atributo que permite a Serialização, pode ser convertida em Objeto
